...
Lightweight and fast chess framework written in Swift. ChessKit is used as a base freamework for Ladoga chess engine.
  ...
  # Or just: spec.author    = "Alexander Perechnev"
  # spec.authors            = { "Alexander Perechnev" => "aperechnev@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Alexander Perechnev"
